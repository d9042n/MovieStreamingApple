//
//  FlowLayoutCompact.swift
//  MovieStreamingApple
//
//  Reusable flow layout for wrapping chips, tags, and badges.
//  Items wrap to the next line when they exceed the container width.
//

import SwiftUI

/// Simple flow layout for wrapping filter chips, genre tags, and other inline elements.
